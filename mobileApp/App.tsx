...
export default function App() {
  ...
  const [selectedVacancy, setSelectedVacancy] = useState<{ id: string, vacancyNumber: number, numberPlate: string, type: string } | null>(null);
  const [isInfoVisible, setIsInfoVisible] = useState(false);

  const [vacancyData, setVacancyDate] = useState<VacancyData[]>([]);
